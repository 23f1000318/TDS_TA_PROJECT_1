...
async def query_knowledge_base(request: QueryRequest) -> QueryResponse:
    try:
        ...
        # ✅ Patch: Clarify 11/10 → 110
        if "11/10" in parsed["answer"] and "110" not in parsed["answer"]:
            parsed["answer"] += " (i.e., the dashboard shows 110 out of 100)."
        ...
        # 🚨 Patch: Add Docker setup guide if relevant
